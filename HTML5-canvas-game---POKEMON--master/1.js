...
window.onload = function() {
    ...
    var canvasFight = document.getElementById("canvasFight");
    var ctxFight = canvasFight.getContext("2d");
    ...
    player.move = function(direction) {
         ...
         */
         var radPkmonWild = 1;
         var fighttingBgr = new Image();
         var exitFighting =  new Image();
        //  function fightting(){
        //    // ctxFight.clearRect(0,0,460,460);
        //     let pokemonwild = new Image();
        //     let pokemonCatch;
        //     fighttingBgr.src = "images/grass.png";
        //     exitFighting.src = "images/move.png";
        //     pokemonwild.src = "images/eevee.png";
        //     //1
        //     if(radPkmonWild == 1)
        //     {
        //         pokemonwild.src = "images/eevee.png";
        //         pokemonCatch = "images/eevee.png"
        //     }
        //     //2
        //     if(radPkmonWild == 2)
        //     {
        //         pokemonwild.src = "images/Keromatsu.jpg";
        //         pokemonCatch =  "images/Keromatsu.jpg";
        //     }
        //     //3
        //     if(radPkmonWild == 3)
        //     {
        //         pokemonwild.src = "images/chamander.jpg";
        //         pokemonCatch    = "images/chamander.jpg";
        //     }
        //     ctxFight.drawImage(fighttingBgr, 0, 0);
        //     ctxFight.drawImage(exitFighting, 100, 160);
        //     ctxFight.drawImage(pokemonwild, 150, 200);

        //     let yourPokemon = document.createElement("IMG");
        //     let yourPokemon = document.createElement("IMG");
        //     let yourPokemon = document.createElement("IMG");
        //     yourPokemon.setAttribute("src", pokemonCatch);
        //     $("body").append(yourPokemon);
        //     // when you cath pokemon it will be in your bag
        //     CollectionPokemon[amount] = pokemonCatch;
        //     amount++;
        ...
        if(player.x == pokeball.x && player.y == pokeball.y) { // found a pokeball !! create a new one
            ...
            radPkmonWild = Math.floor(Math.random() * 3) + 1;    
        }
    ...
    $("#bag").click(function(){
       //    var btn = document.createElement("IMAGE");
        ...
        CollectionPokemon.forEach(function(item) {
            let yourPokemon = document.createElement("IMG");
            yourPokemon.setAttribute("src", item);
