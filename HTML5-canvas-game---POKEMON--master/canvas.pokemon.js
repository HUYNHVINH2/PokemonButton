...
window.onload = function() {
    ...
    player.move = function(direction) {
        ...
        if(player.x == pokeball.x && player.y == pokeball.y) { // found a pokeball !! create a new one
            ...
            radPkmonWild = Math.floor(Math.random() * 6) +1;  
            fightting();  
        }
    ...
    var pokemonwild;
    //outfightting
    $("#outFightting").click(function(){
        $("#pokemonwild").attr("src", "");
        $("#canvas").show();
    })
    // use pokemonball
    $("#usePokeball").click(function(){
        turnCatch++;
       let ratioCatch = Math.floor(Math.random() * 4) + 0;
       if(ratioCatch == 2){
    ...
    function fightting(){
        //1
        console.log(radPkmonWild)
        if(radPkmonWild == 1)
        {
            pokemonwild = "images/eevee.png";
            pokemonCatch = "images/eevee.png"
        }
        //2
        if(radPkmonWild == 2)
        {
            pokemonwild = "images/Keromatsu.jpg";
            pokemonCatch =  "images/Keromatsu.jpg";
        }
        //3
        if(radPkmonWild == 3)
        {
            pokemonwild = "images/chamander.jpg";
            pokemonCatch    = "images/chamander.jpg";
        }

        $("#pokemonwild").attr("src", pokemonwild);
        if(radPkmonWild==1||radPkmonWild==2||radPkmonWild==3){
            $("#canvas").hide();
        }
